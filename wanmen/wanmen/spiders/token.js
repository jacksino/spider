    ...
    n = {
        rotl: function (e, t) {
            ...
            for (var t = [], n = 0; n < e.length; n += 3) for (var i = e[n] << 16 | e[n + 1] << 8 | e[n + 2], o = 0; o < 4; o++) 8 * n + 6 * o <= 8 * e.length ? t.push(a.charAt(i >>> 6 * (3 - o) & 63)) : t.push("=");
            return t.join("")
        }, base64ToBytes: function (e) {
            e = e.replace(/[^A-Z0-9+\/]/gi, "");
            for (var t = [], n = 0, i = 0; n < e.length; i = ++n % 4) 0 != i && t.push((a.indexOf(e.charAt(n - 1)) & Math.pow(2, -2 * i + 8) - 1) << 2 * i | a.indexOf(e.charAt(n)) >>> 6 - 2 * i);
            return t
        }
    }, i = a12.utf8, o = null, s = a12.bin, (r = function (e, t) {
        ...
        for (var a = n.bytesToWords(e), l = 8 * e.length, c = 1732584193, d = -271733879, p = -1732584194, u = 271733878, m = 0; m < a.length; m++) a[m] = 16711935 & (a[m] << 8 | a[m] >>> 24) | 4278255360 & (a[m] << 24 | a[m] >>> 8);
        a[l >>> 5] |= 128 << l % 32;
        a[14 + (l + 64 >>> 9 << 4)] = l;
        var f = r._ff, h = r._gg, v = r._hh, g = r._ii;
    ...
    var time = Math.round((new Date).getTime() / 1e3).toString(16)
    var tokenkey = '5ec029c599f7abec29ebf1c50fcc05a0'
    var token = antitoken(tokenkey + time)
